...
You can ether load the raw track or a "cleaned" version of it. See the `DefaultLocationCleaning` class for details.
...
The following data types are persisted in a SQLite database using the https://developer.android.com/jetpack/androidx/releases/room[Room API].
