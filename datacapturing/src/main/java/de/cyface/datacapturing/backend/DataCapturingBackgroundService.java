...
public class DataCapturingBackgroundService extends Service implements CapturingProcessListener {
    ...
    public void onLocationCaptured(@NonNull final GeoLocation newLocation, @NonNull GeoLocationV6 newLocationV6) {
        ...
        final boolean isCachedLocation = isCachedLocation(newLocation.getTimestamp(), startupTime);
    ...
    static boolean isCachedLocation(final long gpsTime, final long startupTime) {
        final long startupTimeGpsTimeOffset = startupTime - gpsTime;
        final boolean isWeekRollOverBug = gpsTime > 0 && startupTimeGpsTimeOffset > 600000000000L;
        final long fixedTime = isWeekRollOverBug ? gpsTime + 619315200000L : gpsTime;
