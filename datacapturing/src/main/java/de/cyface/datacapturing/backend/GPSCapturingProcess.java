...
public class GPSCapturingProcess extends CapturingProcess {
     ...
     */
    GPSCapturingProcess(final @NonNull LocationManager locationManager, final @NonNull SensorManager sensorService,
            final @NonNull GeoLocationDeviceStatusHandler gpsStatusHandler, final @NonNull HandlerThread geoLocationEventHandlerThread, final @NonNull HandlerThread sensorEventHandlerThread) {
        super(locationManager, sensorService, gpsStatusHandler, geoLocationEventHandlerThread, sensorEventHandlerThread);
    }
