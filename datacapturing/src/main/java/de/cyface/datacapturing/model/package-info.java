 ...
 * ({@link de.cyface.persistence.model.Point3D}). They are
 * {@link de.cyface.persistence.model.DataPoint}s captured at a certain point in time identified by a timestamp in
