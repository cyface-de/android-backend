...
public class ParcelabelTest {
    ...
    public void parcelAndUnParcelCapturedData() {
        ...
        CapturedData oocut = new CapturedData(51.0,13.1,10L,10.0,2,accelerations,rotations,directions);
        ...
        assertThat(data, hasProperty("gpsTime", equalTo(10L)));
        assertThat(data, hasProperty("gpsSpeed", equalTo(10.0)));
        assertThat(data, hasProperty("gpsAccuracy", equalTo(2)));
