...
@Database(
    ...
    // If increased, ensure to implement migration in `main` branch for `measures` Version 18
    version = 1
)
abstract class DatabaseV6 : RoomDatabase() {
    ...
    companion object {
         ...
         */
        @Suppress("MemberVisibilityCanBePrivate") // Used in SDK 7, kept for compatibility
