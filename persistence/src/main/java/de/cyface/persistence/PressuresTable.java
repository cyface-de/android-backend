 ...
 * @since 1.0.0
 */
public class PressuresTable extends AbstractCyfaceMeasurementTable {

    /**
     * The path segment in the table URI identifying the {@link PressuresTable}.
     */
    final static String URI_PATH = "pressures";
    /**
