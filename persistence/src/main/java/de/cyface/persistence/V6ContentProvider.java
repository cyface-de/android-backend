...
/**
 * A content provider for the databased used as cache for all sample points collected via barometer.
 * <p>
 * A different database than {@link MeasuringPointsContentProvider} is used, to ease the migration
 ...
 * @since 6.3.0
 */
public final class V6ContentProvider extends ContentProvider {

    /**
     * A representation of the database manged by this <code>ContentProvider</code>.
     */
    private DatabaseHelperV6 database;
    /**
    ...
    public boolean onCreate() {
        ...
        database = new DatabaseHelperV6(context);
        return true;
    }
