 ...
 * @since 1.0.0
 */
public class PressureTable extends AbstractCyfaceTable {

    /**
     * The path segment in the table URI identifying the {@link PressureTable}.
     */
    final static String URI_PATH = "Pressure";
    // FIXME: The rest of this class is still a copy from GeoLocationTable
    /**
    ...
    /**
     * Don't forget to update the {@link MeasurementProviderHelper}'s {@code DATABASE_VERSION} if you upgrade this table.
     * <p>
     * The Upgrade is automatically executed in a transaction, do not wrap the code in another transaction!
     * <p>
     * This upgrades are called incrementally by {@link MeasurementProviderHelper#onUpgrade(SQLiteDatabase, int, int)}.
     * <p>
     * Remaining documentation: {@link CyfaceTable#onUpgrade}
     */
    @Override
