...
public final class MeasurementSerializer {
     ...
     * @param isEventsTransferFile {@code True} if the {@link EventsFileSerializer#EVENT_TRANSFER_FILE_FORMAT_VERSION}
     *            instead of the Measurement {@link #TRANSFER_FILE_FORMAT_VERSION} should be assembled.
    ...
    private void loadSerializedCompressed(@NonNull final OutputStream fileOutputStream,
        ...
        try {
            ...
            if (isEventsTransferFile) {
                EventsFileSerializer.loadSerializedEvents(bufferedDeflaterOutputStream, loader);
            } else {
