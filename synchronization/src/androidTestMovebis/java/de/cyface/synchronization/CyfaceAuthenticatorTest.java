...
public class CyfaceAuthenticatorTest {
    ...
    public void testAuthenticationHappyPath() throws AuthenticatorException, OperationCanceledException, IOException {
        ...
        Account requestAccount = new Account("test", "de.cyface");
        AccountManagerFuture<Bundle> future = manager.getAuthToken(requestAccount, "de.cyface", null, false, callback,null);
