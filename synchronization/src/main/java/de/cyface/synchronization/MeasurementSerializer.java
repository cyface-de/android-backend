...
final class MeasurementSerializer {
    ...
    /**
     * The current version of the data format. This is always specified by the first two bytes and allows to process different version in parallel.
     */
    ...
    InputStream serialize(final MeasurementLoader loader) {
        ...
        try {
            ...
            byte[] header = createHeader(geoLocationsCursor.getCount(),accelerationsCursor.getCount(),rotationsCursor.getCount(),directionsCursor.getCount());
            ...
            ByteBuffer buffer = ByteBuffer.allocate(header.length + serializedGeoLocations.length + serializedAccelerations.length
     ...
     *
     * @param geoLocationsCursor A <code>Cursor</code> returned by a <code>ContentResolver</code> to load geo locations from.
     ...
     */
    private byte[] createHeader(final int countOfGeoLocations, final int countOfAccelerations, final int countOfRotations, final int countOfDirections) {
