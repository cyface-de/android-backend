 ...
 * @since 7.0.0
 */
public class MeasurementTooLarge extends Exception {

    /**
     * @param detailedMessage A more detailed message explaining the context for this <code>Exception</code>.
     */
    public MeasurementTooLarge(final String detailedMessage) {
    ...
    public MeasurementTooLarge(final String detailedMessage, final Exception cause) {
     ...
     */
    @SuppressWarnings("unused") // May be used in the future
    public MeasurementTooLarge(final Exception cause) {
        super(cause);
    }
}